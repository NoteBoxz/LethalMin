...
namespace LethalMin.Patches
{
    ...
    public class HoarderBugAIPatch
    {
        ...
        {
            if (!LethalMin.LethalBugs) { return; }
            LethalMin.Logger.LogInfo("Hoarder Bug is attacking Pikmin!");

            // Create a coroutine to handle the attack sequence
        ...
        static void ExitAngryState(HoarderBugAI hoarderBug)
        {
            ...
            LethalMin.Logger.LogInfo("Hoarder Bug is no longer angry.");
        }
    }
}